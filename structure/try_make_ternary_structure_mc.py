...
def try_make_ternary_structure_mc(
        log_fname, settings_fname, geo_fname,
        ar, tau, Lr, max_attempts, disks_number,
        disk_thickness=0.1, vertices_number=6,
        stdout_exe=None, stderr_exe=None, structure_exe='./MC_exfoliation'):
    ...
    Required parameters for MX_exfoliation are:
        Lx, thickness, shell_thickness, outer_radius, vertices_number,
    ...
    Parameters:
        ...
        tau              the ratio between the interface thickness and the
                             filler thickness
    ...
    with open(settings_fname, 'w') as f:
        ...
        f.write('shell_thickness {0}\n'.format(disk_thickness * tau))
...
if __name__ == '__main__':
    def test_try_make_ternary_structure_mc():
        geo_fname = 'test.geo'
        log_fname = 'test.log'
        settings_fname = 'test_settings'
        ar = 5
        tau = 1
        Lr = 5
        max_attempts = 100
        disks_number = 10
        try_make_ternary_structure_mc(log_fname, settings_fname, geo_fname,
            ar, tau, Lr, max_attempts, disks_number)

    test_try_make_ternary_structure_mc() # ok
